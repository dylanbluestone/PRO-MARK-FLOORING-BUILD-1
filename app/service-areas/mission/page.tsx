...
export const metadata: Metadata = {
  title: 'Floor Leveling & Hardwood Installation in Mission, BC',
  description: 'Professional floor leveling and hardwood installation in Mission. Local expertise, 5-year warranty, 20+ years experience.',
}
    ...
    <>
      <section className="relative bg-gradient-to-br from-gray-900 to-gray-800 text-white py-20">
        <div className="container-custom">
          <h1>Floor Leveling & Hardwood Installation in Mission, BC</h1>
          <p className="text-xl mb-8">Professional flooring services throughout Mission and surrounding areas</p>
          <Link href="/quote" className="btn-primary text-center">Get Free Quote</Link>
        </div>
      </section>
      <section className="section-padding">
        <div className="container-custom max-w-4xl">
          <h2>Serving Mission with Expert Flooring Services</h2>
          <p className="text-lg text-gray-700 mb-4">
            PROMARK FLOORING proudly serves Mission homeowners, businesses, and contractors. With over 20 years of experience, we provide expert floor leveling, hardwood installation, stair work, and repair services throughout Mission.
          </p>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <h2 className="text-center mb-8">Our Mission Services</h2>
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <Link href="/services/floor-leveling" className="card hover:shadow-lg">
              <h3 className="font-bold mb-2">Floor Leveling</h3>
              <p className="text-gray-700">5-year warranty floor leveling for Mission properties</p>
            </Link>
            <Link href="/services/hardwood-installation" className="card hover:shadow-lg">
              ...
              <p className="text-gray-700">Expert hardwood flooring in Mission</p>
            </Link>
          </div>
        </div>
      </section>
      <section className="section-padding bg-primary-red text-white text-center">
        <div className="container-custom">
          <h2 className="text-white mb-4">Get Your Free Quote in Mission</h2>
